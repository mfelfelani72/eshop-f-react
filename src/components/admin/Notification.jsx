...
import { Button } from '.';
import { chatData } from '../../data/admin/dummy';
...
const Notification = () => {
  ...
  return (
    <div className="nav-item absolute ltr:right-5 rtl:left-5 ltr:md:right-40 rtl:md:left-40 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
