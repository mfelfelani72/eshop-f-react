...
import { cartData } from '../../data/admin/dummy';
import { Button } from '.';

const Cart = () => {
  const { currentColor } = useGeneralContext();

  return (
    <div className="bg-half-transparent w-full fixed nav-item top-0 ltr:right-0 rtl:left-0 ">
      <div className="ltr:float-right rtl:float-left h-screen  duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white md:w-400 p-8">
